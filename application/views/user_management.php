            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                  $count = 0;
                  $query = $this->db->query("SELECT * FROM user WHERE usertype='employee';");
                  foreach ($query->result() as $row)
                  {
                    ...
                    echo "<tr>
                      ...
                      <td class='text-center'>".$row->userpass."</td>
                      <td class='text-center'>
                        <a class='btn btn-success text-uppercase'
                        href='".base_url()."index.php/welcome/useredit/".$row->userslno."'>Update</a>
                      </td>
                      <td class='text-center'>
                        <a class='btn btn-danger text-uppercase'
                        href='".base_url()."index.php/welcome/userdelete/".$row->userslno."'>Delete</a>
                      </td>
                    </tr>";
                  }
                  ?>
